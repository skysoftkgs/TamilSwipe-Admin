...
@session_start();
//API host link
$baseurl = "http://tamilswipeonline.com/API/index.php?p=";
$firebaseDb_URL="https://tamilswipe-986a7.firebaseio.com/";
$ImageBaseurl = "http://tamilswipeonline.com/API/portal/uploads/";
